...
Mit den in Abschnitt~\ref{sub.sub.Annahmen} getroffenen Annahmen erhalten wir durch den Ansatz von Lagrange'schen Tensoren die nachfolgenden Formeln \cite{Cozzlato.2011}.
