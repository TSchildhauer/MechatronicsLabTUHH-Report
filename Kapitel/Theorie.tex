...
%\tau=K_mi
%\end{equation}
%Thomas: Das ist hier nicht an der richtigen Stelle
%\subsection{Herleitung der Modellparameter}
%\label{sub.HerleitungParameter}
%Das mathematische Modell, wie es in Abschnitt~\ref{sub.sub.Mathematisches-Modell} beschrieben ist, wird als Simulink-Modell realisiert.
%Es dient als State-Estimator für den Controller, der in Abschnitt~\ref{sec.Controller} beschrieben wird.
%Das Furuta-Pendel, welches uns im Labor zur Verfügung gestellt wird, muss nun auf die Form des mathematischen Modells gebracht werden.
