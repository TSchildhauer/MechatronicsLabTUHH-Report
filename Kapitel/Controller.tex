...
Beim Starten des Programmes zur Regelung des Pendels wird zunächst identifiziert, um welchen Pendelaufbau es sich handelt. Es wird dabei zwischen zwei zuvor definierten Pendelarmlängen unterschieden.
...
\colorbox{yellow}{Das entsprechende Simulink-Modell in Abb. \ref{fig.Simu_Swing-Up}
zu sehen.}
...
Als Timer, wie sie innerhalb des `ramp' - Blocks zu finden sind, werden grundsätzlich Integrator-Blöcke verwendet. Schließt man am Eingang eines solchen Integrators eine Konstante $1$ an, so ist der Wert des Ausgangs die Zeit seit dem letzten Reset.\\
